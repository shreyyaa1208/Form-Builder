...
// Define the initial state for your forms.
// This holds the data for the form currently being built/edited.
...
const formsSlice = createSlice({
    ...
    reducers: {
        ...
        // Reducer to load a form from the saved forms list, for preview/editing
